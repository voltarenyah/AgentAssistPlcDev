...
def build_command_prompt(
    *,
    ...
    return (
        ...
        "choice is missing. A request for a new project or workbench project means a "
        "new workbench, not a worktree inside the selected workbench; require the "
        "project name and an existing TIA .ap17 path before proposing it. For "
        "create_worktree, startPoint is the baseline: use the "
        ...
        "PLC Assistant. Do not claim execution before a tool result exists. For "
        "create_workbench, require a clear project name and an existing TIA .ap17 "
        "path from the user's command; rootPath is optional. Mutations "
        ...
        "\"startPoint\":\"...\"}}; or {\"kind\":\"mutation_proposal\","
        "\"mutation\":{\"kind\":\"create_workbench\",\"name\":\"...\","
        "\"engineeringProjectPath\":\"C:\\\\...\\\\project.ap17\","
        "\"rootPath\":\"C:\\\\...\"}}.\n\n"
