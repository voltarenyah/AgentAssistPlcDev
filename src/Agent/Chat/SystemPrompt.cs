...
public static class SystemPrompt
{
    ...
    public static string Build() => $"""
        ...
        - The runtime context lists the device's exported source files. Always pick relativePath for src_* tools from that list — never guess TIA export filenames (they carry a " [FC2]"-style suffix the block name alone does not reveal) and never query SQL or the manifest to find paths.
