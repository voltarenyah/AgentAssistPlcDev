...
All Studio UI/UX work must follow [docs/STYLEGUIDE.md](docs/STYLEGUIDE.md),
which designates the Notion design analysis as the canonical guide. Fetch the
current source before a UI/UX change when the required detail is not already in
context. Product safety and accessibility requirements still apply.
