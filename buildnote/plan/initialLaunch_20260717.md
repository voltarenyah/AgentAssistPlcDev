...
| Phase 2.4 — source editor | **Implemented; real-TIA acceptance open** | `src/Mcp.SourceEditor` provides protected parse, preview, apply, diff, and validation tools. Automated tests and all five stdio tool calls pass; import/re-export/compile acceptance on a live TIA V17 project remains open. |
