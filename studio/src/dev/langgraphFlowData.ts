...
export const flowNodes: FlowNode[] = [
  {
    ...
    reference: 'studio/src/api/client.ts · bootstrapAppAssistant', inputs: ['workbench selection'], outputs: ['POST /api/app-assistant/bootstrap'], position: { x: 125, y: 90 },
  },
  {
    ...
    reference: 'studio/src/api/client.ts · chatAppAssistant', inputs: ['user message'], outputs: ['POST /api/app-assistant/chat'], position: { x: 125, y: 252 },
  },
  {
    ...
    reference: 'studio/src/studio/appAssistant/AppAssistantPanel.tsx', inputs: ['pendingApproval'], outputs: ['approval decision'], safety: 'Human approval is the mutation boundary.', position: { x: 125, y: 486 },
  },
  {
    ...
    reference: 'studio/src/studio/appAssistant/appAssistantState.ts', inputs: ['SSE event stream'], outputs: ['messages · runtime · pendingApproval'], event: 'progress → state → interrupt → answer', position: { x: 125, y: 648 },
  },
  {
    ...
    reference: 'src/ApiHost/AppAssistant/AppAssistantChatEndpoints.cs · StreamAssistantAsync', inputs: ['HTTP request'], outputs: ['event: progress'], event: '1 / 4', position: { x: 375, y: 90 },
  },
  {
    ...
    reference: 'src/ApiHost/AppAssistant/AppAssistantChatEndpoints.cs · _response', inputs: ['sidecar JSON'], outputs: ['event: state'], event: '2 / 4', position: { x: 375, y: 252 },
  },
  {
    ...
    reference: 'src/ApiHost/AppAssistant/AppAssistantChatEndpoints.cs · pendingApproval', inputs: ['pendingApproval object'], outputs: ['event: interrupt'], event: '3 / 4', safety: 'Only appears for mutation proposals.', position: { x: 375, y: 486 },
  },
  {
    ...
    reference: 'src/ApiHost/AppAssistant/AppAssistantClient.cs · SendAsync', inputs: ['approval decision'], outputs: ['sidecar resume request'], position: { x: 375, y: 648 },
  },
  {
    ...
    reference: 'src/ApiHost/AppAssistant/AppAssistantChatEndpoints.cs · WriteEventAsync', inputs: ['answer string'], outputs: ['event: answer'], event: '4 / 4', position: { x: 375, y: 790 },
  },
  {
    ...
    reference: 'agent-service/app_assistant/graph.py · build_graph', inputs: ['request state'], outputs: ['bootstrap_context'], position: { x: 625, y: 76 },
  },
  {
    ...
    reference: 'agent-service/app_assistant/graph.py · _bootstrap_async', inputs: ['workbench_id'], outputs: ['runtime_snapshot · context_revision'], position: { x: 625, y: 165 },
  },
  {
    ...
    reference: 'agent-service/app_assistant/graph.py · _orient_async', inputs: ['runtime_snapshot'], outputs: ['orientation_proposal · answer'], safety: 'No gateway detail calls.', position: { x: 625, y: 290 },
  },
  {
    ...
    reference: 'agent-service/app_assistant/graph.py · _decide_async', inputs: ['runtime_snapshot · messages'], outputs: ['decision'], safety: 'Invalid model output becomes clarification.', position: { x: 625, y: 420 },
  },
  {
    ...
    reference: 'agent-service/app_assistant/graph.py · _decision_answer', inputs: ['decision'], outputs: ['answer → END'], position: { x: 625, y: 565 },
  },
  {
    ...
    reference: 'agent-service/app_assistant/graph.py · _read_detail', inputs: ['decision.toolName'], outputs: ['tool_result · detail'], safety: 'Requires a selected worktree.', position: { x: 625, y: 700 },
  },
  {
    ...
    reference: 'agent-service/app_assistant/graph.py · _summarize_async', inputs: ['tool_result'], outputs: ['answer → END'], position: { x: 625, y: 835 },
  },
  {
    ...
    reference: 'agent-service/app_assistant/graph.py · _propose_mutation', inputs: ['mutation · context_revision'], outputs: ['pending approval · mutation result'], safety: 'No mutation call before approval.', position: { x: 625, y: 965 },
  },
  {
    ...
    reference: 'agent-service/app_assistant/graph.py · interrupt', inputs: ['proposal'], outputs: ['__interrupt__'], safety: 'Approval is explicit and resumable.', position: { x: 625, y: 1095 },
  },
  {
    ...
    reference: 'agent-service/app_assistant/graph.py · END edges', inputs: ['graph state'], outputs: ['response envelope'], position: { x: 625, y: 1220 },
  },
  {
    ...
    reference: 'agent-service/app_assistant/gateway.py · get_context', inputs: ['workbench_id'], outputs: ['runtime snapshot'], position: { x: 875, y: 90 },
  },
  {
    ...
    reference: 'agent-service/app_assistant/gateway.py · get_todos/get_history/get_svn', inputs: ['worktree_id · tool name'], outputs: ['structured detail'], safety: 'Read-only path only.', position: { x: 875, y: 610 },
  },
  {
    ...
    reference: 'agent-service/app_assistant/gateway.py · create_worktree/create_workbench', inputs: ['approved proposal'], outputs: ['mutation result'], safety: 'Revision-checked and idempotent.', position: { x: 875, y: 1015 },
  },
  {
    ...
    reference: 'agent-service/app_assistant/graph.py · GatewayStaleError', inputs: ['stale revision'], outputs: ['new runtime_snapshot'], safety: 'Prevents stale writes.', position: { x: 875, y: 1160 },
  },
]
