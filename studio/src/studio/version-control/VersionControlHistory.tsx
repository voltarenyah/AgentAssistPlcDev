                    ...
                    {item.kind === 'commit' ? (
                      <>
                        ...
                        <div className="mb-1.5 flex flex-wrap gap-1" data-testid="commit-badges">
                          ...
                          {item.svnRevision !== null && <span className="rounded bg-surface-muted px-1.5 py-0.5 font-mono text-[10px] text-violet-400" title="Linked SVN revision">r{item.svnRevision}</span>}
                        </div>
                      ...
                      <>
                        ...
                        <div className="mb-1.5 flex flex-wrap gap-1">
                          <span className="rounded bg-surface-muted px-1.5 py-0.5 font-mono text-[10px] text-violet-400">r{item.revision}</span>
